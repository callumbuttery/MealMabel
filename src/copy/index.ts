...
export const copy = {
  ...
  login: {
    title: 'Welcome back',
    subtitle: "Mabel's been keeping your plan warm.",
    ...
    signUp: 'Sign up',
    disclosure: 'This is a preview build, so sign-in is simulated — nothing leaves this device.',
  ...
  register: {
    badge: 'Free forever',
    title: 'Join Mabel',
    subtitle: 'Free weekly plans, smarter shopping in minutes.',
    ...
    logIn: 'Log in',
    disclosure: 'This is a preview build, so sign-up is simulated — nothing leaves this device.',
    invalidEmail: 'Enter a valid email address.',
    failed: "That didn't work — please try again.",
    legalPrefix: 'By continuing you agree to our ',
    legalAnd: ' and ',
  ...
  profile: {
    ...
    account: 'Account',
    accountBody:
      'Not signed in. Mabel already keeps your household, plan and shopping list on this device — sign in if you want to say who you are.',
    signedInAs: (name: string, provider: string) => `Signed in as ${name} via ${provider}.`,
    providerLabel: {
      apple: 'Apple',
      google: 'Google',
      email: 'email',
    ...
    signOutConfirmBody:
      "You'll stay signed out until you sign in again. Your household, plan and shopping list stay saved on this device either way.",
    deleteAccount: 'Delete account',
    deleteConfirmTitle: 'Delete account?',
    deleteConfirmBody:
      "This permanently removes everything Mabel has saved on this device — your household, plan and shopping list. This can't be undone.",
    about: 'About',
    privacy: 'Privacy',
    terms: 'Terms',
    version: 'Version',
  ...
  legal: {
    ...
    privacyBody: [
      'Mabel is a preview build. Your household, plan and shopping list are stored only on this device, using local storage — nothing is sent to a server or shared with anyone else.',
      'There is no account system yet, so nothing here is tied to your name or email. "Sign out", "Delete account" and "Reset demo" in Profile all remove everything Mabel has saved on this device.',
      'When MealMabel adds real accounts and supermarket integrations, this page will be replaced with a full privacy policy covering what is collected, why, and how to control it.',
    ],
    termsTitle: 'Terms',
    termsBody: [
      'This is a demo build of MealMabel. Meal plans, prices and supermarket comparisons are illustrative, generated from a fixed set of sample data — they are not real prices and should not be used for actual shopping decisions.',
      'The app is provided as-is, with no guarantees of accuracy, availability or fitness for a particular purpose while MealMabel is in development.',
      'Full terms of service will apply once MealMabel launches with real accounts and live supermarket data.',
    ],
  },
  components: {
    ...
    mealPhotoPlaceholder: 'Meal photo',
  },
} as const;
